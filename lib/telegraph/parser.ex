defmodule Telegraph.Parser do
  ...
  alias Telegraph.Model.{Video, Voice, Contact, Location, Venue, Update, File, CallbackQuery}
  alias Telegraph.Model.UserProfilePhotos
  alias Telegraph.Model.{Sticker, StickerSet}
